...
public:
  ...
  // add vector for keeping E blockings
  std::vector<isl::map> E_blockings;

  // add vector for keeping F blockings
  std::vector<isl::map> F_blockings;

  isl::map final_F;
  isl::map final_E;

  isl::map write_dependency_map;
  std::vector<isl::map> read_dependency_maps;
...
public:
  ...
  // pipeline (*)
  using PipelineGraph = std::vector<std::pair<MemoryAccess *, MemoryAccess *>>;
...
public:
  ...
  // pipeline (*)
  void multiStmt();
  void getPipelineGraph();
  void getPipelineRelations();
  void getPipelineBlocks();
  void getFinalF();
  void getFinalE();
