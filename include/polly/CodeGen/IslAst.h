...
public:
  ...
  // pipeline (*)
  static bool isTask(const isl::ast_node &Node);
  static bool isInnermostTask(const isl::ast_node &Node);
  static isl_pw_multi_aff *getDependPw(const isl::ast_node &Node);
