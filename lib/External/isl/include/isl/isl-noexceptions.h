...
public:
  ...
  // pipeline (*)
  inline schedule expand(union_pw_multi_aff contraction, schedule expansion) const;
  ...
  // pipeline (*)
  inline schedule set_(schedule schedule2) const;
};
...
// pipeline (*)
schedule schedule::expand(union_pw_multi_aff contraction, schedule expansion) const
{
  auto res = isl_schedule_expand(copy(), contraction.release(), expansion.release());
  // auto res = get();
  return manage(res);
}
...
// pipeline (*)
schedule schedule::set_(schedule schedule2) const
{
